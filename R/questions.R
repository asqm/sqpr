...
#' @param question_name A string specifying the variable name. A search is performed
#' for similar names from all variables in the study. Upper or lower case is ignored
#' and regular expressions are supported.
